    ...
    app.post(
        "/match/friendly",
        {
            schema: {
                ...
                description:
                    "Начинает матч против случайного противника или бота, если никто не найден.",
            },
        },
    ...
    app.post(
        "/match/invite",
        {
            schema: {
                ...
                description:
                    "Генерирует ссылку, по которой любой пользователь может присоединиться к матчу.",
            },
        },
    ...
    app.post(
        "/match/accept/:matchId",
        {
            schema: {
                ...
                description:
                    "Принимает MatchInvite по inviteId (legacy: matchId). Создаёт Match в статусе READY.",
                params: {
                    type: "object",
                    required: ["matchId"],
                    properties: {
    ...
    app.post(
        "/match/:matchId/tactics",
        {
            schema: {
                ...
                description:
                    "Изменить тип прессинга или провести замену во время активного матча.",
                params: {
                    type: "object",
                    required: ["matchId"],
                    properties: {
                            ...
                            items: {
                                ...
                                properties: {
                                    outId: {
                                        type: "string",
                                        description:
                                            "ID игрока, покидающего поле",
                                    },
                                    inId: {
                                        type: "string",
                                        description:
                                            "ID игрока, выходящего на поле",
                                    },
                                },
                                required: ["outId", "inId"],
                            },
