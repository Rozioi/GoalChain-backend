...
exports.checkExpiredRentals = exports.rentService = void 0;
...
exports.rentService = {
    ...
    async rentPlayer(app, renterId, playerId, durationDays) {
        ...
        const commission = Math.floor(player.rentPrice * constants_1.RENT.COMMISSION_RATE);
    ...
    async returnPlayer(app, userId, playerId) {
    ...
    async recallPlayer(app, userId, playerId) {
        const contract = await app.prisma.rentContract.findFirst({
            where: { playerId, status: "ACTIVE" },
        });
        if (!contract)
            throw new Error("This player is not currently rented out");
...
const checkExpiredRentals = (app) => exports.rentService.syncExpiredRentals(app);
